...
public record ChickenUpdateMessage(long id, int chickenPosX, int chickenPosZ, Thickness thickness, Direction lookingDirection) {
  public static ChickenUpdateMessage fromChicken(Chicken chicken){
        return new ChickenUpdateMessage(chicken.getId(), chicken.getChickenPosX(), chicken.getChickenPosZ(), chicken.getThickness(), chicken.getLookingDirection());
    }
}
